...
class TestFencerAgent:
    ...
    def test_valid_actions_list(self):
        ...
        expected = [
            "direct_attack", "compound_attack", "fleche",
            "parry_and_riposte", "counter_attack", "remise", "prise_de_fer"
        ]
...
class TestRefereeAgent:
    ...
    def test_score_accumulates(self):
        ...
        referee.judge_action({"type": "fleche", "target": "torso"}, {"type": "parry", "target": "torso"})
        # Score may or may not change depending on call

        current = referee.score
        total_diff = (current["fencer"] - initial["fencer"]) + (current["opponent"] - initial["opponent"])
    ...
    def test_exchange_history_records_all_exchanges(self):
        ...
        referee.judge_action({"type": "direct_attack", "target": "torso"}, {"type": "parry", "target": "torso"})
        assert len(referee.exchange_history) == 1

        referee.judge_action({"type": "fleche", "target": "torso"}, {"type": "fleche", "target": "torso"})
        assert len(referee.exchange_history) == 2

    def test_current_call_stored(self):
        referee = RefereeAgent()
        result = referee.judge_action({"type": "direct_attack", "target": "torso"}, {"type": "parry", "target": "torso"})
...
class TestCoachAgent:
    ...
    def test_score_analysis_counts_correctly(self):
        ...
        exchange = [
            ...
            {"fencer_action": {}, "opponent_action": {}, "result": {"call": "fencer"}},
            {"fencer_action": {}, "opponent_action": {}, "result": {"call": "opponent"}},
        ]
    ...
    def test_technical_feedback_for_fleche_overuse(self):
        coach = CoachAgent()
        exchange = [
            {"fencer_action": {"type": "fleche", "target": "torso"}, "opponent_action": {}, "result": {"call": "fencer"}},
            {"fencer_action": {"type": "fleche", "target": "torso"}, "opponent_action": {}, "result": {"call": "fencer"}},
            {"fencer_action": {"type": "fleche", "target": "torso"}, "opponent_action": {}, "result": {"call": "opponent"}},
        ]
    ...
    def test_strategic_feedback_for_limited_targets(self):
        coach = CoachAgent()
        exchange = [
            {"fencer_action": {"type": "direct_attack", "target": "torso"}, "opponent_action": {}, "result": {"call": "fencer"}},
            {"fencer_action": {"type": "direct_attack", "target": "torso"}, "opponent_action": {}, "result": {"call": "fencer"}},
            {"fencer_action": {"type": "direct_attack", "target": "torso"}, "opponent_action": {}, "result": {"call": "fencer"}},
            {"fencer_action": {"type": "direct_attack", "target": "torso"}, "opponent_action": {}, "result": {"call": "fencer"}},
            {"fencer_action": {"type": "direct_attack", "target": "torso"}, "opponent_action": {}, "result": {"call": "fencer"}},
    ...
    def test_recommendations_include_fleche_if_not_used(self):
        coach = CoachAgent()
        exchange = [
            {"fencer_action": {"type": "direct_attack"}, "opponent_action": {}, "result": {"call": "fencer"}},
        ]
    ...
    def test_feedback_history_accumulates(self):
        coach = CoachAgent()
        exchange = [{"fencer_action": {}, "opponent_action": {}, "result": {"call": "fencer"}}]
